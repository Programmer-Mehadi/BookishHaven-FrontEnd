...
const EditBook = () => {
  ...
  const editId = useLocation().pathname.split("/")[2];
  let { data: getBook, isLoading, refetch } = useGetSingleBookQuery(editId);
        ...
        fetch(url, {
          ...
          .then((imgbb) => {
            if (imgbb.success) {
              ...
              editBookMutation(submitData as any).then((response) => {
                if ("data" in response) {
        ...
        <div className="w-full max-w-xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
          <form className="space-y-6" onSubmit={(e) => handleSubmit(e)}>
            ...
            <div>
              ...
              <img src={preImage} alt="" className="h-52" />
